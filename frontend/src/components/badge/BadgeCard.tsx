            ...
            <div className="flex flex-wrap gap-3 justify-center mb-4">
                {groupedBadge.badges.map((badge, index) => (
                    <div key={index} className="relative">
                        <div className="group w-14 h-14 rounded-full bg-gradient-to-br from-warning to-warning/60 flex items-center justify-center text-white shadow-lg cursor-pointer">
                            <FaTrophy className="text-lg" />
                            <div className="absolute z-20 opacity-0 group-hover:opacity-100 transition-opacity bg-base-100 border border-base-300 text-xs text-left text-base-content rounded-lg shadow-lg p-2 bottom-0 left-1/2 -translate-x-1/2 translate-y-full w-max pointer-events-none">
