...
export const PageInfoAlert: React.FC<PageInfoAlertProps> = ({
    ...
    return (
        <motion.div
            ...
            className={`mb-10 rounded-xl bg-gradient-to-r ${colorFrom} ${colorTo} border border-purple-200/40 p-4 flex items-center gap-4 shadow-sm`}
        >
            <motion.div
            ...
            <div className="text-sm text-gray-800 leading-relaxed text-center flex flex-col items-center justify-center w-full">
