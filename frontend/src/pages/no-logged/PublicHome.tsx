          ...
          <div className="grid md:grid-cols-2 gap-12 items-center py-16">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
                Dive into an interactive learning experience with real-time
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {user ? (
                  <Link to="/quiz-review">
                    ...
                    >
                      Review Quizzes
                      <FiCheckSquare className="ml-2 transform group-hover:translate-x-1 transition-transform" />
                    </motion.button>
                  </Link>
                ) : (
                  <motion.button
        ...
        >
          ...
          <div className="relative">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold mb-4">Join a Quiz Session</h2>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Showcase your expertise and progress with our badge system. Each
              badge represents a milestone in your learning journey.
            </p>
          </motion.div>
