...
export const CourseCRUDProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  ...
  const assignCourseMutation = useMutation(
    (id: string) => courseApi.apiCoursesAssignIdPut({ id }),
    {
      onSuccess: () => {
        queryClient.invalidateQueries(["teacherCourses"]);
        queryClient.invalidateQueries(["allCourses"]);
  ...
  const leftCourseMutation = useMutation(
    (id: string) => courseApi.apiCoursesLeftIdPut({ id }),
    {
      onSuccess: () => {
        queryClient.invalidateQueries(["teacherCourses"]);
        queryClient.invalidateQueries(["allCourses"]);
  ...
  const value = useMemo(
    () => ({
      ...
      errorAssignCourse: assignCourseMutation.error,
